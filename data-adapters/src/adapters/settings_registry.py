...
SETTINGS_REGISTRY: dict[str, tuple[str, tuple[str, ...]]] = {
    ...
    "UI_DASHBOARD_TX_STREAM_URL": ("text", ()),
    "UI_DEFAULT_CONSUMER_NAME": ("text", ()),
    "UI_DEFAULT_LOCALE": ("select", ("en", "es")),
    "UI_DEFAULT_THEME": ("select", ("system", "light", "dark")),
    ...
    "BEACON_TX_MONITOR_ENABLED": ("bool", ()),
    "BEACON_SVXLINK_LOG_PATH": ("text", ()),
